...
public class Main {
	public static void main(String[] args) {
		...
		UIManager.put("Tree.collapsedIcon", ImageResizer.getInstance().getProperlyScaledImage("chevron-right.png", 10, 10));
		UIManager.put("Tree.expandedIcon", ImageResizer.getInstance().getProperlyScaledImage("chevron-down.png", 10, 10));
