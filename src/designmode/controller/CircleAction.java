...
public class CircleAction extends AbstractAction {
	public CircleAction() {
		...
		putValue(SMALL_ICON, ImageResizer.getInstance().loadSmallIcon("circle.png"));
		putValue(LARGE_ICON_KEY, ImageResizer.getInstance().loadBigIcon("circle.png"));
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(docView != null) {
			...
			mainPageView.getStateManager().setCircleState();
		}
	}
}
